...
source("benchmark_final.R")   # sinh ra benchmark_results/benchmark_*.png và .csv
```
...
Benchmark trên dữ liệu tổng hợp (`interaction_sd = 0,90`, 36 strata giao thoa, 2×3×3×2). Máy: Windows 10, R 4.3.3, Intel Core i7-13700H, 16 GB RAM. Kết quả trung bình qua 2–3 lần chạy mỗi cấu hình. Dữ liệu thô: `benchmark_results/benchmark_all.csv`.
...
![Biểu đồ thời gian tính toán](benchmark_results/benchmark_time.png)
![Biểu đồ tuyến tính phương pháp nhanh](benchmark_results/benchmark_fast_linear.png)
...
![So sánh VPC](benchmark_results/benchmark_vpc.png)
